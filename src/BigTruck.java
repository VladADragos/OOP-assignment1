...
public class BigTruck extends Truck {
    ...
    void addCar(Car car){
        ...
        // done?
        if(rampIsDown && car.getEnginePower() < 300 && flak.size()<maxNumCars && car.hashCode() != this.hashCode() && position.isClose(car.getPosition(),50)){
     ...
     */
    void setRampIsDown(boolean rampIsDown) {
